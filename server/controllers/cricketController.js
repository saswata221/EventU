// server/controllers/cricketController.js
...
/**
 * POST /api/cricket/import
 * Body: { fixtures: [ . ] }
 * (Same behaviour as your football import endpoint)
 */
async function importFixtures(req, res) {
  ...
  try {
    ...
    console.error("cricket importFixtures error:", err);
...
/**
 * GET /api/cricket?limit=50&offset=0&openpark_id=1
...
async function getEvents(req, res) {
  try {
    ...
    console.error("cricket getEvents error:", err);
    res
      .status(500)
